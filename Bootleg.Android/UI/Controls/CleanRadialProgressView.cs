...
namespace RadialProgress
{
    ...
    using Android.Graphics;
    using Android.Util;
    using global::RadialProgress.RadialProgress;
    ...
    namespace RadialProgress
    {
        internal class AttributesParser
        {
            ...
            public Color ProgressColor = CleanRadialProgressView.DefaultColor;
    ...
    public class CleanRadialProgressView : View
    {
        const float borderWidthPercentage = 0.018691589f;
        const float lineWidthPercentage = 0.026074766f;
        ...
        public Color ProgressColor
        {
            ...
            set
            {
                ...
                bgBorderPaint.Color = ProgressColor;
                bgCirclePaint.Color = ProgressColor;
            }
        }
        ...
        public CleanRadialProgressView(Context context, IAttributeSet attributes) : base(context, attributes)
        {
        ...
        void InitPaints()
        {
            ...
            bgProgressPaint.Color = progressColor;
