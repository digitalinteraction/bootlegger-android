...
{
    [Android.Runtime.Register("uk.ac.ncl.openlab.bootlegger.UploadsFabAwareBehaviour")]
    public class UploadsFabAwareBehaviour : CoordinatorLayout.Behavior
    {
        public UploadsFabAwareBehaviour(Context context, IAttributeSet attrs):base()
        {
        ...
        {
            return dependency is SnackbarLayout || dependency.Id == Resource.Id.uploadtile;
        }
        ...
        //public UploadsFabAwareBehaviour(Context context, FloatingActionButton thisbutton, int page, ViewPager pager) : base()
        //{
